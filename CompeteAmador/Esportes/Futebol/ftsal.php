...
<body>
  ...
  <div class="container-fluid mt-2">
    ...
    $query = "SELECT cod, idcri, nomet, estado, cidade, bairro, rua, datalanc, datafim, datainicio, responsavel, valorinsc, descricao, telefonet, modalidades, vagas, vagasatu, njogadores, categoria, uniformes, genero FROM torneio WHERE modalidades = 5 AND datainicio >= '$dataAtual'";
    ...
    while ($campo = mysqli_fetch_array($seleciona)) {
      ...
      $estadoNM = $dadosEstado['nome'];
        ...
        <div class="card mt-4"  data-genero="<?= strtolower($generoNome) ?>" data-categoria="<?= strtolower($categoriaNome) ?>" data-estado="<?= strtolower($idEstado) ?>" data-cidade="<?= strtolower($idCidade) ?>"data-inicio="<?= strtolower($dataDIA) ?>" >
            <img src="../Fotos/ftsal.jpeg" class="card-img-top" alt="Imagem do torneio">
            <div class="card-body">
