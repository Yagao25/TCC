...
-- Criação da tabela USUARIO (sem referência circular)
...
-- Criação da tabela UNIFORMES
CREATE TABLE Uniformes (
  id INT(1) PRIMARY KEY AUTO_INCREMENT,
  uniformes varchar(17) DEFAULT NULL
);
...
CREATE TABLE TORNEIO (
  ...
  valorinsc VARCHAR(6) NOT NULL,
  descricao VARCHAR(50) NOT NULL,
  telefonet VARCHAR(15) NOT NULL,
  modalidades INT NOT NULL,
  vagas INT NOT NULL,
  vagasatu INT NOT NULL,
  categoria INT NOT NULL,
  uniformes INT NOT NULL,
  njogadores INT NOT NULL,
  genero INT NOT NULL,
  FOREIGN KEY (estado) REFERENCES Estado(id),
  FOREIGN KEY (cidade) REFERENCES Cidade(id),
  FOREIGN KEY (modalidades) REFERENCES Modalidades(id),
  FOREIGN KEY (categoria) REFERENCES Categoria(id),
  FOREIGN KEY (genero) REFERENCES Genero(id),
  FOREIGN KEY (uniformes) REFERENCES Uniformes(id)
);

-- Criação da tabela ACESSO_TORNEIO
CREATE TABLE ACESSO_TORNEIO (
    cod INT AUTO_INCREMENT PRIMARY KEY,
    codusuario INT NOT NULL,
    codmodalidade INT NOT NULL,
    datavisu DATETIME NOT NULL,
    FOREIGN KEY (codusuario) REFERENCES USUARIO(cod),  -- Relacionamento com a tabela USUARIO
  FOREIGN KEY (codmodalidade) REFERENCES Modalidades(id)   -- Relacionamento com a tabela TORNEIO
);

-- Criação da tabela Compra (corrigida)
CREATE TABLE Compra (
  id INT AUTO_INCREMENT PRIMARY KEY,
  id_usuario INT NOT NULL,
  id_torneio INT NOT NULL,
  vagascompradas INT NOT NULL,
  datacom DATE NOT NULL,
  FOREIGN KEY (id_usuario) REFERENCES USUARIO(cod),  -- Relacionamento com a tabela USUARIO
  FOREIGN KEY (id_torneio) REFERENCES TORNEIO(cod)   -- Relacionamento com a tabela TORNEIO
);
