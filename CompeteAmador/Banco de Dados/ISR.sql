...
INSERT INTO Modalidades (id, modalidades, foto) VALUES
(1, 'Basquete 3x3', 'basquete_quadra.jpg'),
(2, 'Basquete de quadra', 'basquete_quadra.jpg'),
(3, 'Futebol 11', 'futebol11.jpg'),
(4, 'Futebol 7', 'futebol7.jpg'),
(5, 'Futsal', 'futsal.jpg'),
(6, 'Footvolley', 'footvolley.jpg'),
(7, 'Handebol de praia', 'handebol_praia.jpg'),
(8, 'Handebol de quadra', 'handebol_quadra.jpg'),
(9, 'Voleibol de areia', 'voleibol_areia.jpg'),
(10, 'Voleibol de quadra', 'voleibol_quadra.jpg'),
(16, 'Todo', 'imagem_todo.jpg');
...
INSERT INTO Uniformes (id, uniformes) VALUES
(1, 'Não obrigatório'),
(2, 'Somente camisa'),
(3, 'Uniforme completo');
...
SELECT * FROM ACESSO_TORNEIO;

SELECT * FROM CADASTRO_TORNEIO;
...
Scrip para demostração completo



-- USUARIO
INSERT INTO USUARIO (nome, cpf, senha, email, telefone, datanasc, foto)
VALUES ('John Doe', '123.456.789-00', 'password123', 'johndoe@example.com', '(11) 98765-4321', '1990-01-01', 'profile.jpg'),
       ('Jane Doe', '098.765.432-10', 'password456', 'janedoe@example.com', '(11) 98765-4322', '1991-02-02', 'profile2.jpg');

-- ESTADO
INSERT INTO Estado (id, nome, uf) VALUES ('1', 'Rio Grande do Sul', 'RS'), ('2', 'São Paulo', 'SP');

-- CIDADE
INSERT INTO Cidade (id, nome, uf, ibge) VALUES ('1', 'Porto Alegre', 'RS', '4314902'), ('2', 'São Paulo', 'SP', '3550308');

-- MODALIDADES
INSERT INTO Modalidades (modalidades, foto) VALUES ('Futebol', 'futebol.jpg'), ('Vôlei', 'volei.jpg');

-- CATEGORIA
INSERT INTO Categoria (categoria) VALUES ('Sub-17'), ('Sub-20');

-- GENERO
INSERT INTO Genero (genero) VALUES ('Masculino'), ('Feminino');

-- UNIFORMES
INSERT INTO Uniformes (uniformes) VALUES ('Camisa e calção'), ('Camisa');

-- TORNEIO
INSERT INTO TORNEIO (estado, cidade, bairro, rua, datalanc, datafim, datainicio, responsavel, valorinsc, 
descricao, telefone, modalidades, vagas, categoria, uniformes, njogadores, genero, formapag)
VALUES (1, 1, 'Centro', 'Rua da Paz', '2024-03-10', '2024-03-12', '2024-03-11', 'João Silva', 100.00, 'Torneio de Futebol', 
'(11) 98765-4323', 1, 10, 1, 1, 10, 1, 1),
       (2, 2, 'Vila Nova', 'Rua das Flores', '2024-03-15', '2024-03-17', '2024-03-16', 'Maria Oliveira', 80.00, 'Torneio de Vôlei', 
'(11) 98765-4324', 2, 12, 2, 2, 12, 2, 2);

-- ACESSO_TORNEIO
INSERT INTO ACESSO_TORNEIO (codusuario, codtorneio, data, hora) VALUES (1, 1, '2024-03-10', '10:00:00'), (2, 2, '2024-03-15', '14:00:00');

-- CADASTRO_TORNEIO
INSERT INTO CADASTRO_TORNEIO (codusuario, codtorneio, data, hora) VALUES (1, 1, '2024-03-10', '11:00:00'), (2, 2, '2024-03-15', '15:00:00');
